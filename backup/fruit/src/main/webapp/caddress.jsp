...
try
{
	...
	con = DriverManager.getConnection("jdbc:mysql://localhost:3306/backend", "root", "Dhobi@07");
	pstmt=con.prepareStatement("insert into clocation(address,city,state,country,pincode) values(?,?,?,?,?)");
